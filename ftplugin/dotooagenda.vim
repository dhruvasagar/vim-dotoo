...
function ReturnToDotooAgenda()
  if getwinvar(winnr('#'), '&filetype') == "dotooagenda"
    wincmd p
  endif
endfunction
...
nnoremap <buffer> <silent> <nowait> i :<C-U>call dotoo#agenda#start_headline_clock()<bar>call ReturnToDotooAgenda()<CR>
nnoremap <buffer> <silent> <nowait> o :<C-U>call dotoo#agenda#stop_headline_clock()<bar>call ReturnToDotooAgenda()<CR>
