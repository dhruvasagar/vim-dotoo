...
nnoremap <buffer> <silent> <nowait> . :<C-U>call dotoo#agenda#adjust_current_date('.')<CR>
nnoremap <buffer> <silent> <nowait> f :<C-U>call dotoo#agenda#adjust_current_date('+1d')<CR>
nnoremap <buffer> <silent> <nowait> b :<C-U>call dotoo#agenda#adjust_current_date('-1d')<CR>
